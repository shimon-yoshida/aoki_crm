              ...
              <div class="container px-5 py-8 mx-auto">
                <div class="lg:w-1/2 md:w-2/3 mx-auto">
                  <div class="flex flex-wrap -m-2">
                    ...
                    <div class="p-2 w-full">
                      <div class="relative">
                        <label for="is_selling" class="mr-3 leading-7 text-sm text-gray-600"
                          >ステータス</label
                        >
                        <input
                          type="radio"
                          id="is_selling" class="ml-3"
                          name="is_selling" v-model="form.is_selling" value="1"
                        ...
                        <input
                          type="radio"
                          id="is_selling" class="ml-3"
                          name="is_selling" v-model="form.is_selling" value="0"
